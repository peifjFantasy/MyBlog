...
<script type="text/javascript">
	...
	function refreshSystem(){
		$.post("${pageContext.request.contextPath}/admin/system/refreshSystem",{},
				function (result) {
					if(result.success){
						$.messager.alert("系统提示","已刷新！")
					}else {
	 ...
	 */
	function logout(){
		$.messager.confirm("系统提示","您确定要退出系统吗？",function (ok) {
			if(ok){
	...
	<table style="padding: 5px" width="100%">
		<tr>
			...
			<td style="padding-top: 16px" valign="middle" align="right" width="50%">
				<font size="3">&nbsp;&nbsp;<strong>欢迎：</strong>${sessionScope.current_user.userName}</font>
			</td>
		</tr>
	</table>
</div>
...
<div id="dlg" class="easyui-dialog" style="width: 400px;height: 200px;padding: 10px 20px"
	...
	<form id="fm" method="post">
		<table cellspacing="8px">
			<tr>
				<td>用户名：</td>
				<td><input type="text" name="userName" id="userName" readonly="readonly" value="${sessionScope.current_user.userName}" style="width: 200px"></td>
			</tr>
			<tr>
				<td>新密码：</td>
				<td><input type="password" name="newPassword" id="newPassword" class="easyui-validatebox" required="true" style="width: 200px"></td>
			</tr>
			<tr>
				<td>确认密码：</td>
				<td><input type="password" name="newPassword2" id="newPassword2" class="easyui-validatebox" required="true" style="width: 200px"></td>
			</tr>
		</table>
	</form>
</div>
<div id="dlg-buttons">
	...
	<a href="javascript:closeModPwdDialog()" class="easyui-linkbutton" iconCls="icon-cancel">关闭</a>
</div>
