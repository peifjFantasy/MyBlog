...
<script type="text/javascript">
    ...
    function openBlogTypeAddDialog() {
        ...
        url="${pageContext.request.contextPath}/admin/blogType/saveBlogType";
    }
    ...
    function openBlogTypeUpdateDialog() {
        ...
        /*修改前回显该行数据*/
        $("#fm").form("load",row);
        url="${pageContext.request.contextPath}/admin/blogType/saveBlogType?id="+row.id;
    }
    ...
    function deleteBlogType() {
        ...
        $.messager.confirm("系统提示","确定要删除这<font color='red'>"+selectedRows.length+"</font>条数据吗？",function (r) {
            if(r){
                $.post("${pageContext.request.contextPath}/admin/blogType/deleteBlogType",{ids:ids},function (result) {
                    if(result.success){
                        if(result.exist){
...
<body style="margin: 1px">
    <table id="dg" title="博客类别管理" class="easyui-datagrid" fitcolumns="true" pagination="true" rownumbers="true"
           url="${pageContext.request.contextPath}/admin/blogType/showAllBlogType"
           fit="true" toolbar="#tb">
        <thead>
        <tr>
