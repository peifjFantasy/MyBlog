...
<script type="text/javascript">
        ...
        function submitData() {
            ...
            if(title==null || title==""){
                ...
                $.post("${pageContext.request.contextPath}/admin/blog/saveBlog",
                    {   'title': title,
                        'id':'${param.id}',
...
<div id="p" class="easyui-panel" title="修改博客" style="padding: 10px">
    <table cellspacing="20px">
        ...
        <tr>
            <td>所属类别：</td>
            <td>
                <select class="easyui-combobox" type="text" id="blogTypeId" name="blogType.id"
                        style="width: 155px;" editable="false" panelHeight="auto">
        ...
        <tr>
            ...
            <td><a href="javascript:submitData()" class="easyui-linkbutton"
                   data-options="iconCls:'icon-submit'">修改博客
            </a>
            </td>
        </tr>
    </table>
...
<script type="text/javascript">
    ...
    ue.addListener("ready",function(){
        //通过ajax请求数据
        UE.ajax.request("${pageContext.request.contextPath}/admin/blog/findBlogById",
            {
                method:"post",
                asyc:false,
                data:{"id":"${param.id}"},
                onsuccess:function (result) {
                    /*result现在就是在控制器中被转换为json对象的blog*/
                    result=eval("("+result.responseText+")");
                    /*把该对象中的属性填充到具体位置，实现表单回显*/
